...
mixin CustomMovementByJoystick on SimplePlayer {
  ...
  void _correctPositionToCenterTile() {
    int w = (position.x / PacManWorld1HomeScreen.tileSize).round();
    int h = (position.y / PacManWorld1HomeScreen.tileSize).round();
    position = Vector2(w * PacManWorld1HomeScreen.tileSize,
        h * PacManWorld1HomeScreen.tileSize);
  }
